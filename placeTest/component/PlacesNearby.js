...
import PlacesList from "../component/PlaceList";
...
const PlacesNearby = ()=>{
    ...
    return (
        <div className="places-container">
            ...
            <PlacesList placesList={placesList} clicksss={findPlaceOnclick}/>  
            {/* Thanks to Ma Ling Knowlege LEARNED */}
        </div>
    )
